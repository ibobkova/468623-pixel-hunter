...
import gameThirdScreen from './game-3-screen';
...
formGame.addEventListener(`click`, () => {
  if (formGame.querySelector(`.game__answer input:checked + span`)) {
    setTimeout(() => {
      changeScreen(gameThirdScreen);
      formGame.reset();
    }, 500);
  }
});

export default gameSecondScreen;
