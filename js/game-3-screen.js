...
const gameThirdScreen = render(template);
const formGame = gameThirdScreen.querySelector(`.game__content`);

formGame.addEventListener(`click`, () => {
  setTimeout(changeScreen, 500, statsScreen);
});

export default gameThirdScreen;
